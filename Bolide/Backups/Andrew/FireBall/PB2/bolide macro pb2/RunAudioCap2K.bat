...
set outputFile=teststatus_AudioCap2K.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
:ACTIONS
echo //////////////////////////////////////////////////////////////////// ACTIONS               
AudioCapConsoleApp.exe -OutputFile teststatus_AudioCap2K.txt -recdev "USB Audio Device",0x046d,0x0821 -samfreq 16000 -bps 16 -channels 2 -playdev "Default DirectSound Device" -soundsource "Sinewave2K.wav" -wait 500 -size 16000 -PCMFileOut Recorded2K.wav -recvol 0.8 -playvol 0 -slave
pause
:END_ACTIONS
echo ////////////////////////////////////////////////////////////////////  END_ACTIONS   
