...
set outputFile=teststatus_AudioCalc2K_filtered.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
:ACTIONS
echo //////////////////////////////////////////////////////////////////// ACTIONS               
AudioCalcConsoleApp.exe -OutputFile teststatus_AudioCalc2K_filtered.txt -PCMFileIn Recorded2K_filtered.wav -freq 2000 -slave -LogFile datalog_AudioCalc2K_filtered.csv -TestLimits 2000HzLimit.txt
