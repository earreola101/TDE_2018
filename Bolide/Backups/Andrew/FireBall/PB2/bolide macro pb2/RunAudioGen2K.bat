...
set outputFile=teststatus_AudioGen2K.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
:ACTIONS
echo //////////////////////////////////////////////////////////////////// ACTIONS               
AudioGenConsoleApp.exe -OutputFile teststatus_AudioGen2K.txt -PCMfileOut Sinewave2K.wav -freq 2000 -samfreq 16000 -amp 0.5 -bps 16 -size 32000 -slave
