@echo on
AudioCapConsoleApp.exe -OutputFile teststatus_AudioCapTele10s.txt -recdev "(Umik-1  Gain: 12dB ",0x2752,0x0007 -samfreq 16000 -bps 16 -channels 2 -size 160000 -PCMFileOut RecordedTele10s.wav -recvol 0.5 -slave
