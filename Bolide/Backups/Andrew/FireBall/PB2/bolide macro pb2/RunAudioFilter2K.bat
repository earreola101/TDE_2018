...
set outputFile=teststatus_AudioFilter2K.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
:ACTIONS
echo //////////////////////////////////////////////////////////////////// ACTIONS               
AudioFilterConsoleApp.exe -OutputFile teststatus_AudioFilter2K.txt -PCMFileIn Recorded2K.wav -loCut 1500 -hiCut 2500 -slave
