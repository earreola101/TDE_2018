@echo on
AudioCapConsoleApp.exe -OutputFile teststatus_AudioCapWide10s.txt -recdev "Microphone (USB Audio CODEC )",0x08bb,0x29b0 -samfreq 16000 -bps 16 -channels 2 -size 160000 -PCMFileOut RecordedWide10s.wav -recvol 0.5 -slave

set oldname=RecordedWide10s.wav
