...
set outputFile=teststatus_AudioFilterTele10s.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
:ACTIONS
echo //////////////////////////////////////////////////////////////////// ACTIONS               
AudioFilterConsoleApp.exe -OutputFile teststatus_AudioFilterTele10s.txt -PCMFileIn RecordedTele10s.wav -loCut 300 -hiCut 1000 -slave
