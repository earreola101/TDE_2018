...
set outputFile=teststatus_AudioFilterWide10s.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
:ACTIONS
echo //////////////////////////////////////////////////////////////////// ACTIONS               
AudioFilterConsoleApp.exe -OutputFile teststatus_AudioFilterWide10s.txt -PCMFileIn RecordedWide10s.wav -loCut 300 -hiCut 1000 -slave
