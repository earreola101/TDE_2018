...
:ACTIONS
echo //////////////////////////////////////////////////////////////////// ACTIONS               
AudioCapConsoleApp.exe -OutputFile teststatus_AudioCap1K.txt -recdev "Microphone (USB Audio CODEC )",0x08bb,0x29b0 -samfreq 16000 -bps 16 -channels 2 -size 160000 -PCMFileOut Recorded1K10s.wav -recvol 1.0 -slave
