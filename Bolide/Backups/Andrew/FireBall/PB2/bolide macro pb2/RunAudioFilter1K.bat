...
set outputFile=teststatus_AudioFilter1K.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
:ACTIONS
echo //////////////////////////////////////////////////////////////////// ACTIONS               
AudiofilterConsoleApp.exe -OutputFile teststatus_AudioFilter1K.txt -PCMFileIn Recorded1K.wav -loCut 500 -hiCut 1500 -slave
