...
set outputFile=teststatus_AudioCalcTele10s.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
:ACTIONS
echo //////////////////////////////////////////////////////////////////// ACTIONS               
AudioCalcConsoleApp.exe -OutputFile teststatus_AudioCalcTele10s.txt -PCMFileIn RecordedTele10s.wav -freq 300 -windowSize 80000 -TestLimits testlimit_TeleMotorNoise.txt -LogFile datalog_RecordedTele10s.csv -slave
