...
REM -slave
AudioCalcConsoleApp2 -advanced -PCMFileIn ".\recorded\Mariner_SPK_8L_RB.wav" -TimeRange 0.0,5.0 -fftsize 8192 -TestLimits ".\limits\testlimit_AudioCalc_SPK_8L_RB.txt" -OutputFile "testOutput_AudioCalc_SPK_8L_RB.txt" -TestHeaders ".\limits\testheader_AudioCalc_SPK_8L_RB.csv" -slave
COPY ".\histogram.csv" ".\datalog\histogram_Mariner_SPK_8L_RB.csv" 
pause
:END_ACTIONS
echo ////////////////////////////////////////////////////////////////////  END_ACTIONS   
