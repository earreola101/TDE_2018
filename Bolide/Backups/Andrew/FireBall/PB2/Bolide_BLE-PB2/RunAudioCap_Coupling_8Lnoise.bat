...
REM -PCMFileOut ".\recorded\Meridian_Coupling_8L.wav" 
REM -recvol 0.5 
REM -playvol 0.5 
REM -samfreq 48000 
REM -bps 16 
...
REM -slave 
AudioCapConsoleApp -test speaker -playdev %MeridianSPK% -recdev %MeridianMIC% -soundsource ".\stimulus\Sweep_3s_96k_-90dB_24bit_White.wav" -PCMFileOut ".\recorded\Meridian_Motor_noise.wav" -recvol 0.55 -playvol 0.32 -samfreq 48000 -bps 16 -channels 2 -sampleTime 5.0 -OutputFile "testOutput_AudioCap_Coupling_8Lnoise.txt" -slave 
