...
REM -slave 
AudioCapConsoleApp -test speaker -playdev %MeridianSPK% -recdev %MeridianMIC% -soundsource ".\stimulus\SweepTone SPKR FR THD_18000Hz_100Hz_-3dBFS_5s.wav" -PCMFileOut ".\recorded\Meridian_Coupling_8L.wav" -recvol 0.35 -playvol 0.32 -samfreq 48000 -bps 16 -channels 2 -sampleTime 5.0 -OutputFile "testOutput_AudioCap_Coupling_8L.txt" -slave 
