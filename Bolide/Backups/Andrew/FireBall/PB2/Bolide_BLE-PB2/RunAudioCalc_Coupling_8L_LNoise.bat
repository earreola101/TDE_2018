...
AudioCalcConsoleApp2 -advanced -PCMFileIn ".\recorded\Meridian_Motor_noise.wav" -LeftChannel -TimeRange 0.0,5.0 -fftsize 8192 -TestLimits ".\limits\testlimit_AudioCalc_ExtMIC_Noise.txt" -OutputFile "testOutput_AudioCalc_Coupling_8L_Lnoise.txt" -TestHeaders ".\limits\testheader_AudioCalc_ExtMIC_Noise.csv" -slave

COPY ".\histogram.csv" ".\datalog\histogram_Meridian_Coupling_8L_Lnoise.csv" 
pause
:END_ACTIONS
echo ////////////////////////////////////////////////////////////////////  END_ACTIONS   
