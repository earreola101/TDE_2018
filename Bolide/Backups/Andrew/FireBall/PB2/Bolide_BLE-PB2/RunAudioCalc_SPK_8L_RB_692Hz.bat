...
REM -slave
AudioCalcConsoleApp2 -advanced -PCMFileIn ".\recorded\Meridian_SPK_8L_RB_692Hz.wav" -TimeRange 0.0,3.0 -fftsize 8192 -TestLimits ".\limits\testlimit_AudioCalc_SPK_8L_RB_692Hz.txt" -OutputFile "testOutput_AudioCalc_SPK_8L_RB_692Hz.txt" -TestHeaders ".\limits\testheader_AudioCalc_SPK_8L_RB_692Hz.csv" -slave
COPY ".\histogram.csv" ".\datalog\histogram_Meridian_SPK_8L_RB_692Hz.csv" 
pause
:END_ACTIONS
echo ////////////////////////////////////////////////////////////////////  END_ACTIONS   
