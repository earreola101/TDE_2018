...
rem //////////////////////////////////VARIBLES//////////////////////////////////////
Set dirPath=%CD%
set outputFile=testOutput_AudioCalc_SPK_8L_RB_323Hz.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
REM -slave
AudioCalcConsoleApp2 -advanced -PCMFileIn ".\recorded\Mariner_SPK_8L_RB_323Hz.wav" -TimeRange 0.0,3.0 -fftsize 8192 -TestLimits ".\limits\testlimit_AudioCalc_SPK_8L_RB_323Hz.txt" -OutputFile "testOutput_AudioCalc_SPK_8L_RB_323Hz.txt" -TestHeaders ".\limits\testheader_AudioCalc_SPK_8L_RB_323Hz.csv" -slave
COPY ".\histogram.csv" ".\datalog\histogram_Mariner_SPK_8L_RB_323Hz.csv" 
pause
:END_ACTIONS
echo ////////////////////////////////////////////////////////////////////  END_ACTIONS   
...
rem === Begin 30-Dec-2014 Henry: Data Collection only for Rub and Buzz test
set STATUS=0
