...
rem //////////////////////////////////VARIBLES//////////////////////////////////////
Set dirPath=%CD%
set outputFile=testOutput_AudioCalc_SPK_8L_RB_150Hz.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
REM -slave
AudioCalcConsoleApp2 -advanced -PCMFileIn ".\recorded\Mariner_SPK_8L_RB_150Hz.wav" -TimeRange 0.0,3.0 -fftsize 8192 -TestLimits ".\limits\testlimit_AudioCalc_SPK_8L_RB_150Hz.txt" -OutputFile "testOutput_AudioCalc_SPK_8L_RB_150Hz.txt" -TestHeaders ".\limits\testheader_AudioCalc_SPK_8L_RB_150Hz.csv" -slave
COPY ".\histogram.csv" ".\datalog\histogram_Mariner_SPK_8L_RB_150Hz.csv" 
pause
:END_ACTIONS
echo ////////////////////////////////////////////////////////////////////  END_ACTIONS   
...
rem ==== Begin 30-Dec-2014 Henry for Rub and Buzz test data collection only
set STATUS=0
