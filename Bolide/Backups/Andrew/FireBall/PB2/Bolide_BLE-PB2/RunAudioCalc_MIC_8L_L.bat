...
rem //////////////////////////////////VARIBLES//////////////////////////////////////
Set dirPath=%CD%
set outputFile=testOutput_AudioCalc_MIC_8L_L.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
REM -slave
AudioCalcConsoleApp2 -advanced -PCMFileIn ".\recorded\Mariner_MIC_8L.wav" -LeftChannel -TimeRange 0.0,3.0 -fftsize 8192 -TestLimits ".\limits\testlimit_AudioCalc_MIC_8L_L.txt" -OutputFile "testOutput_AudioCalc_MIC_8L_L.txt" -TestHeaders ".\limits\testheader_AudioCalc_MIC_8L_L.csv" -slave

COPY ".\histogram.csv" ".\datalog\histogram_Mariner_MIC_8L_L.csv" 
pause
:END_ACTIONS
echo ////////////////////////////////////////////////////////////////////  END_ACTIONS   
