...
REM -slave
AudioCalcConsoleApp2 -frequencyanalysis -PCMFileIn ".\recorded\Meridian_Coupling_8L_MIC3.wav" -LeftChannel -TimeRange 0.0,5.0 -fftsize 8192 -TestLimits ".\limits\testlimit_AudioCalc_Coupling_8L_LMIC3.txt" -OutputFile "testOutput_AudioCalc_Coupling_8L_LMIC3.txt" -TestHeaders ".\limits\testheader_AudioCalc_Coupling_8L_LMIC3.csv" -slave
...
COPY ".\recorded\Meridian_Coupling_8L_MIC3.wav" "%BKDIR%"
COPY ".\datalog\histogram_Meridian_Coupling_8L_MIC3_L.csv" "%BKDIR%"
