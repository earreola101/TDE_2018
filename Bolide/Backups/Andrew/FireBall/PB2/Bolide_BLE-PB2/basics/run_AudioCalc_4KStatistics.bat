...
Set dirPath=%CD%
set outputFile=testOutput_Sinewave4K_Statistics.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
rem -TestLimits "%~dp0testlimit_Sinewave4K_Statistics.csv" 
rem -OutputFile "%~dp0testOutput_SineWave4K_Statistics.txt" 
rem -slave
rem 
..\AudioCalcConsoleApp2 -statistics -PCMFileIn "%~dp0SingleTone_48k_16_1_TcLw_4kHz_-3dBFS_2s.wav" -TimeRange 0.5,2.0 -TestLimits "%~dp0testlimit_Sinewave4K_Statistics.csv" -OutputFile "%~dp0testOutput_SineWave4K_Statistics.txt" -slave
...
move "%~dp0testOutput_Sinewave4K_Statistics.txt" "%BKDIR%"
move "..\NiStatistics.csv" "%BKDIR%"
rem ===========================================================
