...
REM -slave
AudioCalcConsoleApp2 -advanced -PCMFileIn ".\recorded\Meridian_Coupling_8L.wav" -LeftChannel -TimeRange 0.0,5.0 -fftsize 8192 -TestLimits ".\limits\testlimit_AudioCalc_Coupling_8L_L.txt" -OutputFile "testOutput_AudioCalc_Coupling_8L_L.txt" -TestHeaders ".\limits\testheader_AudioCalc_Coupling_8L_L.csv" -slave

COPY ".\histogram.csv" ".\datalog\histogram_Meridian_Coupling_8L_L.csv" 
pause
:END_ACTIONS
echo ////////////////////////////////////////////////////////////////////  END_ACTIONS   
