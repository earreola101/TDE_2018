...
set STARTTIME=%TIME%
rem 
rem pull up test tracking info from a Hector and save it to Hector.log
rem ..\TestTrackingConsoleApp 
rem -config "%CD%\Hector.ini" 
rem -onFileOfHistory "%CD%\Hector.log"
rem 
..\TestTrackingConsoleApp -config "%CD%\Hector.ini" -onFileOfHistory "%CD%\Hector.log"
set ENDTIME=%TIME%
