...
rem //////////////////////////////////VARIBLES//////////////////////////////////////
Set dirPath=%CD%
set outputFile=testOutput_AudioCalc_Coupling_8L_LMIC2.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
REM -slave
AudioCalcConsoleApp2 -frequencyanalysis -PCMFileIn ".\recorded\Meridian_Coupling_8L_MIC2.wav" -LeftChannel -TimeRange 0.0,3.0 -fftsize 8192 -TestLimits ".\limits\testlimit_AudioCalc_Coupling_8L_LMIC2.txt" -OutputFile "testOutput_AudioCalc_Coupling_8L_LMIC2.txt" -TestHeaders ".\limits\testheader_AudioCalc_Coupling_8L_LMIC2.csv" -slave

COPY ".\histogram.csv" ".\datalog\histogram_Meridian_Coupling_8L_MIC2_L.csv" 
rem pause
:END_ACTIONS
echo ////////////////////////////////////////////////////////////////////  END_ACTIONS   
...
COPY ".\recorded\Meridian_Coupling_8L_MIC2.wav" "%BKDIR%"
COPY ".\datalog\histogram_Meridian_Coupling_8L_MIC2_L.csv" "%BKDIR%"
