...
rem //////////////////////////////////VARIBLES//////////////////////////////////////
Set dirPath=%CD%
set outputFile=testOutput_AudioCalc_Coupling_8L_LMIC4.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
AudioCalcConsoleApp2 -frequencyanalysis -PCMFileIn ".\recorded\Meridian_Coupling_8L_MIC4.wav" -LeftChannel -TimeRange 0.0,5.0 -fftsize 8192 -TestLimits ".\limits\testlimit_AudioCalc_Coupling_8L_LMIC4.txt" -OutputFile "testOutput_AudioCalc_Coupling_8L_LMIC4.txt" -TestHeaders ".\limits\testheader_AudioCalc_Coupling_8L_LMIC4.csv" -slave

COPY ".\histogram.csv" ".\datalog\histogram_Meridian_Coupling_8L_MIC4_L.csv" 
rem pause
:END_ACTIONS
echo ////////////////////////////////////////////////////////////////////  END_ACTIONS   
...
COPY ".\recorded\Meridian_Coupling_8L_MIC4.wav" "%BKDIR%"
COPY ".\datalog\histogram_Meridian_Coupling_8L_MIC4_L.csv" "%BKDIR%"
