...
SET FixtureMIC="Microphone (USB Audio CODEC )",0x8bb,0x29b0
...
REM -slave 
AudioCapConsoleApp -test speaker -playdev %MeridianSPK% -recdev %FixtureMIC% -soundsource ".\stimulus\SweepTone SPKR FR THD_18000Hz_100Hz_-3dBFS_5s.wav" -PCMFileOut ".\recorded\Meridian_SPK_8L_FR.wav" -recvol 0.85 -playvol 0.75 -samfreq 48000 -bps 16 -channels 1 -sampleTime 5.0 -OutputFile "testOutput_AudioCap_SPK_8L_FR.txt" -slave 
