...
rem //////////////////////////////////VARIBLES//////////////////////////////////////
Set dirPath=%CD%
set outputFile=testOutput_AudioCap_SPK_8L_RB_692Hz.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
REM -slave 
AudioCapConsoleApp -test speaker -playdev %MeridianSPK% -recdev %FixtureMIC% -soundsource ".\stimulus\Tone SPKR R&B 692Hz 0dBFS 3sec.wav" -PCMFileOut ".\recorded\Meridian_SPK_8L_RB_692Hz.wav" -recvol 0.35 -playvol 0.35 -samfreq 48000 -bps 16 -channels 1 -sampleTime 3.0 -OutputFile "testOutput_AudioCap_SPK_8L_RB_692Hz.txt" -slave 
