...
SET MeridianMIC="Echo Cancelling Speakerphone (2- Logi Meridian Speakerphone)",0x46d,0x867
...
REM -PCMFileOut ".\recorded\Meridian_Coupling_8L_MIC3.wav" 
REM -recvol 0.5 
REM -playvol 0.5 
REM -samfreq 48000 
REM -bps 16 
...
REM -slave 
AudioCapConsoleApp -test speaker -playdev %MeridianSPK% -recdev %MeridianMIC% -soundsource ".\stimulus\SweepTone SPKR FR THD_18000Hz_100Hz_-3dBFS_5s.wav" -PCMFileOut ".\recorded\Meridian_Coupling_8L_MIC4.wav" -recvol 0.3 -playvol 0.3 -samfreq 48000 -bps 16 -channels 2 -sampleTime 5.0 -OutputFile "testOutput_AudioCap_Coupling_8L.txt" -slave 
