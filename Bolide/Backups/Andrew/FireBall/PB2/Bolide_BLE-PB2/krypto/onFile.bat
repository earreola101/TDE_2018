...
set STARTTIME=%TIME%
rem 
rem pull up test tracking info from a Krypto and save it to Krypto.log
rem ..\TestTrackingConsoleApp 
rem -config "%CD%\Krypto.ini" 
rem -onFileOfHistory "%CD%\Krypto.log"
rem 
..\TestTrackingConsoleApp -config "%CD%\Krypto.ini" -onFileOfHistory "%CD%\Krypto.log"
set ENDTIME=%TIME%
