...
SET FixtureMIC="5- USB Audio Device",0x46d,0x080c
...
REM -PCMFileOut ".\recorded\Mariner_SPK_8L.wav" 
REM -recvol 0.05 
REM -playvol 0.5 
REM -samfreq 48000 
REM -bps 16 
...
REM -slave 
AudioCapConsoleApp -test speaker -playdev %MeridianSPK% -recdev %FixtureMIC% -soundsource ".\stimulus\SweepTone SPKR FR THD_18000Hz_100Hz_-3dBFS_5s.wav" -PCMFileOut ".\recorded\Mariner_SPK_8L_FR.wav" -recvol 0.45 -playvol 0.75 -samfreq 48000 -bps 16 -channels 1 -sampleTime 5.0 -OutputFile "testOutput_AudioCap_SPK_8L_FR.txt" -debug 
