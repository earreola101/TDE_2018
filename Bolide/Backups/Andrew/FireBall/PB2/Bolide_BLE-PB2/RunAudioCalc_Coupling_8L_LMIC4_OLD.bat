...
rem //////////////////////////////////VARIBLES//////////////////////////////////////
Set dirPath=%CD%
set outputFile=testOutput_AudioCalc_Coupling_8L_L.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
REM -slave
AudioCalcConsoleApp2 -advanced -PCMFileIn ".\recorded\Meridian_Coupling_8L_MIC4.wav" -LeftChannel -TimeRange 0.0,2.0 -fftsize 8192 -TestLimits ".\limits\testlimit_AudioCalc_Coupling_8L_LMIC4.txt" -OutputFile "testOutput_AudioCalc_Coupling_8L_L.txt" -TestHeaders ".\limits\testheader_AudioCalc_Coupling_8L_LMIC4.csv" -slave
