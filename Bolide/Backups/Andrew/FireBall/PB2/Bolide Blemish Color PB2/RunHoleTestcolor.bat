...
set outputFile=teststatus_sensorholescolor.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
:ACTIONS      
SensorChipDPDConsoleApp -BMPFileIn %IMAGE_TARGET% -TestSettings testconfig_sensorholescolor.txt -TestLimits testlimit_sensorholescolor.txt -OutputFile teststatus_sensorholescolor.txt -LogFile datalog_sensorholescolor.txt -slave
copy AllClusters.csv AllClusters_HOLEScolor.csv
del AllClusters.csv
copy Worst64Pixels.csv Worst64Pixels_HOLEScolor.csv
...
rem del %IMAGE_TARGET%
copy Worst64Pixels_HOLEScolor.csv "%BKDIR%"
copy AllClusters_HOLEScolor.csv "%BKDIR%"
del "c:\tstplan\SSD\Dust_180.bmp"
