...
set STARTTIME=%TIME%
rem 
rem pull up test tracking info from a Bolide and save it to Bolide.log
rem ..\TestTrackingConsoleApp 
rem -config "%~dp0Bolide.ini" 
rem -onFileOfHistory "%~dp0Bolide.log"
rem 
..\TestTrackingConsoleApp -config "%~dp0Bolide.ini" -onFileOfHistory "%~dp0Bolide.log"
set ENDTIME=%TIME%
