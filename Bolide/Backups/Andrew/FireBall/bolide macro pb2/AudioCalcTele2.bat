...
set outputFile=teststatus_AudioCalcTele10sFiltered.txt
set STATUS=
set RETURNCODE=
set MESSAGE=
set LOGFILE=
...
:ACTIONS
echo //////////////////////////////////////////////////////////////////// ACTIONS               
AudioCalcConsoleApp.exe -OutputFile teststatus_AudioCalcTele10sFiltered.txt -PCMFileIn RecordedTele10s_Filtered.wav -freq 500 -windowlength 80000 -dataOffset 0 -TestLimits testlimit_TeleMotorNoiseFiltered.txt -LogFile datalog_RecordedTele10sFiltered.csv -slave
